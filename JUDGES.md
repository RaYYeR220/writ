...
43 scenarios in [`eval/scenarios.json`](eval/scenarios.json), written and committed **before** the
...
The committed fork scorecard: 43 ran, 0 errored, **0 false approvals**, 0 false refusals, 9 correct
approvals, 34 correct refusals, 21/21 traps refused, 4/4 negative controls failed as designed, 0
mechanism mismatches; 28 answered adversarially, 15 supplied a correct answer.
