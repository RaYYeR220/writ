...
| 2.9 | `teeSignerAcknowledged` can only be set by 0G's registry owner. There is **no** self-acknowledgement entry point | VERIFIED-LIVE | the deployed beacon implementation `0x1c0A264f5ae6cfC37E8695442fB139efD884Ca48` contains the selector for `acknowledgeTEESignerByOwner(address)` (`0xb2394d09`) and does not contain `acknowledgeTEESigner()` (`0x7d484904`) or `acknowledgeTEESigner(address)` (`0x515579e8`). Owner is `0xddCDcbD9C7aeFB165dE00CE8684907fAAe8C8224` |
